...
export default function App() {
  ...
  async function carregaTempo(){
    const response = await Api.get(`weather?array_limit=1&fields=only_results,temp,city_name,forecast,max,min,date,description&key=1e2e36cc&city_name=${cidade},SP`);
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.bloco}>
          ...
          <TextInput 
            placeholder='Hey amiguinho, escolha uma cidade para descobrir o clima!'
            style={styles.input}
            value={cidade}
